...
const formSchema = z.object({
   name: z.string().min(1), value: z.string().min(4).regex(/^#/, {message: "string must be a valid hex code"})
})
...
export const ColorForm: React.FC<ColorFormProps> = ({initialData}) => {
   ...
   const form = useForm<ColorFormValue>({
      resolver: zodResolver(formSchema), defaultValues: initialData || {name: "", value: "",}
   })
